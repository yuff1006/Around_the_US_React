...
function App() {
  ...
  // handleEditAvatarClick = (isOpen) => {
  //   isEditProfilePopupOpen = isOpen;

  //   document.querySelector(".popup_profile-pic").classList.add("popup_open");
  // };
  // handleEditProfileClick = () => {
  //   document.querySelector("#popup").classList.add("popup_open");
  // };
  // handleAddPlaceClick = () => {
  //   document.querySelector(".popup_picture").classList.add("popup_open");
  // };
  // handleCardClick = () => {
  //   //ToDo
  // };
